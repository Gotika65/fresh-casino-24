...
function denyWager(message){verdictView.textContent=message;wagerInput.classList.remove('rl-deny-ffb230a6');void wagerInput.offsetWidth;wagerInput.classList.add('rl-deny-ffb230a6');}
...
var brandEl=document.querySelector('.rl-brand-ffb230a6');var echoEl=grab('rl-echo');if(brandEl&&echoEl){echoEl.textContent=brandEl.textContent.replace(/\s+/g,' ').trim();}
